...
vis5d_load_v5dfile $idisp_ctx 500 cbay.v5d DataContext0

vis5d_init_path $idisp_ctx .
vis5d_init_map $idisp_ctx OUTLUSAM
set hires 0
vis5d_init_topo $idisp_ctx cbay.topo $hires
...
vis5d_set_color $idisp_ctx VIS5D_BACKGROUND 0 0.3 0.4 0.6 1.0

vis5d_graphics_mode $idisp_ctx VIS5D_TOPO VIS5D_ON

vis5d_set_topo_base $idisp_ctx 1 0.0

...
vis5d_init_path $idisp_ctx data/vis5d
vis5d_init_map $idisp_ctx OUTLUSAM
set hires 0
vis5d_init_topo $idisp_ctx EARTH.TOPO $hires
...
vis5d_set_hwindslice $idisp_ctx 0 0.5 2.0 $l_mid
vis5d_set_color $idisp_ctx VIS5D_HWIND 0 0.0 1.0 1.0 1.0

vis5d_set_vwindslice $idisp_ctx 0 1.0 1.0 $r_mid $c_min $r_mid $c_max
vis5d_set_color $idisp_ctx VIS5D_VWIND 0 1.0 0.0 1.0 1.0

set lev [ expr ($l_mid + $l_min) / 2.0 ]
vis5d_set_hstreamslice $idisp_ctx 0 1.0 $lev

set col [ expr ($c_mid + $c_max) / 2.0 ]
vis5d_set_vstreamslice $idisp_ctx 0 1.0 $r_min $col $r_max $col

# Isosurfaces

vis5d_set_isosurface $idata_ctx SPD 40.0
vis5d_set_color $idata_ctx VIS5D_ISOSURF SPD 0.9 1.0 0.0 1.0
...
vis5d_set_hslice $idata_ctx SPD 10.0 0.0 100.0 $l_mid

vis5d_set_vslice $idata_ctx SPD 10.0 0.0 100.0 $r_min $c_mid $r_max $c_mid
...
cave5d_parm_set ALL_PANELS_CONFIG	data/config/panel.mini
cave5d_parm_set INIT_POSITION 		0.0	5.0	-5.0
cave5d_parm_set INIT_ROTATION		0.0	0.0	0.0
cave5d_parm_set INIT_SCALE		5.0	5.0	5.0
...
cave5d_menu_item GOBJ "H_Contours - SPD" VIS5D_HSLICE SPD
cave5d_menu_item GOBJ "V_Contours - SPD" VIS5D_VSLICE SPD
cave5d_menu_item GOBJ "H_Slice - Temp" VIS5D_CHSLICE T
#cave5d_menu_item GOBJ "H_Slice - Temp" VIS5D_CHSLICE T2
cave5d_menu_item GOBJ "H_Slice - SPD" VIS5D_CHSLICE SPD
cave5d_menu_item GOBJ "V_Slice - SPD" VIS5D_CVSLICE SPD
cave5d_menu_item GOBJ "H_Slice - Streamlines" VIS5D_HSTREAM 0
cave5d_menu_item GOBJ "V_Slice - Streamlines" VIS5D_VSTREAM 0
cave5d_menu_item GOBJ "H_Slice - Winds" VIS5D_HWIND 0
cave5d_menu_item GOBJ "V_Slice - Winds" VIS5D_VWIND 0
cave5d_menu_item GOBJ "Isosurf - SPD" VIS5D_ISOSURF SPD
